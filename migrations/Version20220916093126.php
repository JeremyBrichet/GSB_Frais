 ...
 */
final class Version20220916093126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_frais CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_frais CHANGE user_id user_id INT DEFAULT NULL');
